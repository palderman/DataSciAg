...
This course will be delivered remotely in synchronous format. That is, I will facilitate class sessions remotely, but students will be able to meet in the classroom at the regularly scheduled meeting times. At times, students may be permitted to participate remotely when unable meet in person for valid reasons (e.g. if sick or in quarantine). In such cases, the student should contact the instructor in advance to make appropriate arrangements.
...
>  Phone: (405)744-9604 \
>  Virtual Office Hours:  Tue 10:30am-12pm, Thu 3-4:30pm or by appointment
...
J.B. Arnold. _R for Data Science: Exercise Solutions_. 2020. URL: https://jrnold.github.io/r4ds-exercise-solutions.
...
schedule <- {as.POSIXct('2021-08-17') + weeks(0:15)} %>% 
  ...
  mutate(`Assignment Due` = ifelse(Module == "*Introduction*",
                                   "",
                                   `Assignment Due`)) %>% 
  select(Module,Dates,`Assignment Due`) %>% 
  rename(`Due Date` = `Assignment Due`)
...
\includepdf[pages=-]{Fall-2021-syllabus-attachment-7-21-21.pdf}