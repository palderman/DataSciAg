...
2. Use the `read_all_divisions()` function to import the full dataset. Then use the `estimate_biomass()` function to estimate tree biomass and store it in a new column of the original tibble.
